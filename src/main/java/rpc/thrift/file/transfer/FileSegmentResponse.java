...
public class FileSegmentResponse implements org.apache.thrift.TBase<FileSegmentResponse, FileSegmentResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FileSegmentResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FileSegmentResponse");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FileSegmentResponseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FileSegmentResponseTupleSchemeFactory();

  /**
   * 
   * @see ResResult
   */
  public @org.apache.thrift.annotation.Nullable ResResult uploadStatusResult; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FileSegmentResponse.class, metaDataMap);
  }

  public FileSegmentResponse() {
  }
   ...
   */
  public FileSegmentResponse(FileSegmentResponse other) {
  ...
  public FileSegmentResponse deepCopy() {
    return new FileSegmentResponse(this);
  }
   ...
   * @see ResResult
   */
  public FileSegmentResponse setUploadStatusResult(@org.apache.thrift.annotation.Nullable ResResult uploadStatusResult) {
    this.uploadStatusResult = uploadStatusResult;
    return this;
  }
  ...
  public FileSegmentResponse setNextPos(long nextPos) {
  ...
  public FileSegmentResponse setErrorMsg(@org.apache.thrift.annotation.Nullable String errorMsg) {
  ...
  public boolean equals(Object that) {
    if (that instanceof FileSegmentResponse)
      return this.equals((FileSegmentResponse)that);
    return false;
  }

  public boolean equals(FileSegmentResponse that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(FileSegmentResponse other) {
    ...
    lastComparison = Boolean.compare(isSetUploadStatusResult(), other.isSetUploadStatusResult());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetNextPos(), other.isSetNextPos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNextPos()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FileSegmentResponse(");
    boolean first = true;
  ...
  private static class FileSegmentResponseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FileSegmentResponseStandardScheme getScheme() {
      return new FileSegmentResponseStandardScheme();
    }
  }

  private static class FileSegmentResponseStandardScheme extends org.apache.thrift.scheme.StandardScheme<FileSegmentResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FileSegmentResponse struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // UPLOAD_STATUS_RESULT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.uploadStatusResult = ResResult.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileSegmentResponse struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FileSegmentResponseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FileSegmentResponseTupleScheme getScheme() {
      return new FileSegmentResponseTupleScheme();
    }
  }

  private static class FileSegmentResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<FileSegmentResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FileSegmentResponse struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FileSegmentResponse struct) throws org.apache.thrift.TException {
