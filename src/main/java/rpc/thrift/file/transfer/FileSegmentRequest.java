...
public class FileSegmentRequest implements org.apache.thrift.TBase<FileSegmentRequest, FileSegmentRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FileSegmentRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FileSegmentRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new FileSegmentRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new FileSegmentRequestTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable String fileName; // required
  public @org.apache.thrift.annotation.Nullable String saveParentFolder; // optional
  public @org.apache.thrift.annotation.Nullable String relativePath; // optional
  /**
   * 
   * @see FileTypeEnum
   */
  public @org.apache.thrift.annotation.Nullable FileTypeEnum fileType; // required
  public @org.apache.thrift.annotation.Nullable String identifier; // required
  public long startPos; // optional
  public @org.apache.thrift.annotation.Nullable String checkSum; // optional
  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer contents; // optional
   ...
   * @see EncryptTypeEnum
   */
  public @org.apache.thrift.annotation.Nullable EncryptTypeEnum encryptedType; // optional
  ...
  private static final _Fields optionals[] = {_Fields.SAVE_PARENT_FOLDER,_Fields.RELATIVE_PATH,_Fields.START_POS,_Fields.CHECK_SUM,_Fields.CONTENTS,_Fields.ENCRYPTED,_Fields.ENCRYPTED_TYPE,_Fields.TOTAL_FILE_LENGTH};
  ...
  static {
    ...
    tmpMap.put(_Fields.CHECK_SUM, new org.apache.thrift.meta_data.FieldMetaData("checkSum", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FileSegmentRequest.class, metaDataMap);
  }
   ...
   */
  public FileSegmentRequest(FileSegmentRequest other) {
  ...
  public FileSegmentRequest deepCopy() {
    return new FileSegmentRequest(this);
  }
  ...
  public FileSegmentRequest setFileName(@org.apache.thrift.annotation.Nullable String fileName) {
    this.fileName = fileName;
    return this;
  }
  ...
  public FileSegmentRequest setSaveParentFolder(@org.apache.thrift.annotation.Nullable String saveParentFolder) {
  ...
  public FileSegmentRequest setRelativePath(@org.apache.thrift.annotation.Nullable String relativePath) {
   ...
   * @see FileTypeEnum
   */
  public FileSegmentRequest setFileType(@org.apache.thrift.annotation.Nullable FileTypeEnum fileType) {
    this.fileType = fileType;
    return this;
  }
  ...
  public FileSegmentRequest setIdentifier(@org.apache.thrift.annotation.Nullable String identifier) {
    this.identifier = identifier;
    return this;
  }
  ...
  public FileSegmentRequest setStartPos(long startPos) {
  ...
  public FileSegmentRequest setCheckSum(@org.apache.thrift.annotation.Nullable String checkSum) {
  ...
  public FileSegmentRequest setContents(byte[] contents) {
    this.contents = contents == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(contents.clone());
    return this;
  }

  public FileSegmentRequest setContents(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer contents) {
  ...
  public FileSegmentRequest setBytesLength(int bytesLength) {
    this.bytesLength = bytesLength;
    setBytesLengthIsSet(true);
    return this;
  }
  ...
  public FileSegmentRequest setEncrypted(boolean encrypted) {
   ...
   * @see EncryptTypeEnum
   */
  public FileSegmentRequest setEncryptedType(@org.apache.thrift.annotation.Nullable EncryptTypeEnum encryptedType) {
  ...
  public FileSegmentRequest setTotalFileLength(long totalFileLength) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case SAVE_PARENT_FOLDER:
      if (value == null) {
        ...
        setSaveParentFolder((String)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that instanceof FileSegmentRequest)
      return this.equals((FileSegmentRequest)that);
    return false;
  }

  public boolean equals(FileSegmentRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(FileSegmentRequest other) {
    ...
    lastComparison = Boolean.compare(isSetSaveParentFolder(), other.isSetSaveParentFolder());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSaveParentFolder()) {
    ...
    lastComparison = Boolean.compare(isSetRelativePath(), other.isSetRelativePath());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRelativePath()) {
    ...
    lastComparison = Boolean.compare(isSetFileType(), other.isSetFileType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFileType()) {
    ...
    lastComparison = Boolean.compare(isSetStartPos(), other.isSetStartPos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStartPos()) {
    ...
    lastComparison = Boolean.compare(isSetCheckSum(), other.isSetCheckSum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCheckSum()) {
    ...
    lastComparison = Boolean.compare(isSetBytesLength(), other.isSetBytesLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBytesLength()) {
    ...
    lastComparison = Boolean.compare(isSetEncrypted(), other.isSetEncrypted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEncrypted()) {
    ...
    lastComparison = Boolean.compare(isSetEncryptedType(), other.isSetEncryptedType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEncryptedType()) {
    ...
    lastComparison = Boolean.compare(isSetTotalFileLength(), other.isSetTotalFileLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTotalFileLength()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FileSegmentRequest(");
    boolean first = true;
  ...
  private static class FileSegmentRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FileSegmentRequestStandardScheme getScheme() {
      return new FileSegmentRequestStandardScheme();
    }
  }

  private static class FileSegmentRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<FileSegmentRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FileSegmentRequest struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // FILE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.fileType = FileTypeEnum.findByValue(iprot.readI32());
          ...
          case 11: // ENCRYPTED_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.encryptedType = EncryptTypeEnum.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileSegmentRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FileSegmentRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public FileSegmentRequestTupleScheme getScheme() {
      return new FileSegmentRequestTupleScheme();
    }
  }

  private static class FileSegmentRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<FileSegmentRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FileSegmentRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FileSegmentRequest struct) throws org.apache.thrift.TException {
