...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.15.0)", date = "2022-01-01")
public class FileUploadRequest implements org.apache.thrift.TBase<FileUploadRequest, FileUploadRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FileUploadRequest> {
    ...
    private static final org.apache.thrift.protocol.TField EMPTY_FILE_FIELD_DESC = new org.apache.thrift.protocol.TField("emptyFile", org.apache.thrift.protocol.TType.BOOL, (short) 13);
    ...
    public @org.apache.thrift.annotation.Nullable
    String saveParentFolder; // optional
    public @org.apache.thrift.annotation.Nullable
    ...
    public boolean emptyFile; // optional
    ...
    private static final int __EMPTYFILE_ISSET_ID = 4;
    private byte __isset_bitfield = 0;
    private static final _Fields optionals[] = {_Fields.SAVE_PARENT_FOLDER, _Fields.RELATIVE_PATH, _Fields.START_POS, _Fields.CONTENTS, _Fields.BYTES_LENGTH, _Fields.ENCRYPTED, _Fields.ENCRYPTED_TYPE, _Fields.TOTAL_FILE_LENGTH, _Fields.EMPTY_FILE};
    ...
    static {
        ...
        tmpMap.put(_Fields.TOTAL_FILE_LENGTH, new org.apache.thrift.meta_data.FieldMetaData("totalFileLength", org.apache.thrift.TFieldRequirementType.OPTIONAL,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.EMPTY_FILE, new org.apache.thrift.meta_data.FieldMetaData("emptyFile", org.apache.thrift.TFieldRequirementType.OPTIONAL,
                new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    ...
    public FileUploadRequest(FileUploadRequest other) {
        ...
        this.emptyFile = other.emptyFile;
    }
    ...
    public FileUploadRequest setFileName(@org.apache.thrift.annotation.Nullable String fileName) {
        this.fileName = fileName;
        return this;
    }
    ...
    public FileUploadRequest setSaveParentFolder(@org.apache.thrift.annotation.Nullable String saveParentFolder) {
    ...
    public FileUploadRequest setRelativePath(@org.apache.thrift.annotation.Nullable String relativePath) {
    ...
    public FileUploadRequest setIdentifier(@org.apache.thrift.annotation.Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
    ...
    public FileUploadRequest setCheckSum(@org.apache.thrift.annotation.Nullable String checkSum) {
        this.checkSum = checkSum;
        return this;
    }
    ...
    public FileUploadRequest setEmptyFile(boolean emptyFile) {
        this.emptyFile = emptyFile;
        setEmptyFileIsSet(true);
        return this;
    }

    public void unsetEmptyFile() {
        __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __EMPTYFILE_ISSET_ID);
    }

    /**
     * Returns true if field emptyFile is set (has been assigned a value) and false otherwise
     */
    public boolean isSetEmptyFile() {
        return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __EMPTYFILE_ISSET_ID);
    }

    public void setEmptyFileIsSet(boolean value) {
        __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __EMPTYFILE_ISSET_ID, value);
    }
    ...
    public boolean equals(FileUploadRequest that) {
        ...
        boolean this_present_emptyFile = true && this.isSetEmptyFile();
        boolean that_present_emptyFile = true && that.isSetEmptyFile();
        if (this_present_emptyFile || that_present_emptyFile) {
            if (!(this_present_emptyFile && that_present_emptyFile))
                return false;
            if (this.emptyFile != that.emptyFile)
                return false;
        }
    ...
    public int hashCode() {
        ...
        hashCode = hashCode * 8191 + ((isSetEmptyFile()) ? 131071 : 524287);
        if (isSetEmptyFile())
            hashCode = hashCode * 8191 + ((emptyFile) ? 131071 : 524287);
    ...
    public int compareTo(FileUploadRequest other) {
        ...
        lastComparison = Boolean.compare(isSetEmptyFile(), other.isSetEmptyFile());
        if (lastComparison != 0) {
            return lastComparison;
        }
        if (isSetEmptyFile()) {
            lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.emptyFile, other.emptyFile);
            if (lastComparison != 0) {
                return lastComparison;
            }
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("FileUploadRequest(");
        boolean first = true;
    ...
    private static class FileUploadRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<FileUploadRequest> {
        ...
        public void read(org.apache.thrift.protocol.TProtocol iprot, FileUploadRequest struct) throws org.apache.thrift.TException {
            ...
            while (true) {
                ...
                switch (schemeField.id) {
                    ...
                    case 13: // EMPTY_FILE
                        if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
                            struct.emptyFile = iprot.readBool();
                            struct.setEmptyFileIsSet(true);
                        } else {
                            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
                        }
                        break;
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, FileUploadRequest struct) throws org.apache.thrift.TException {
            ...
            if (struct.isSetEmptyFile()) {
                oprot.writeFieldBegin(EMPTY_FILE_FIELD_DESC);
                oprot.writeBool(struct.emptyFile);
                oprot.writeFieldEnd();
            }
