...
public class ConfigDataHelper {
    ...
    public static void loadConfigData() {
        try {
            ...
            saveStoreConfigDataIfConfigNotExists(BusinessConstant.ConfigData.CLIENT_UPLOAD_LIMIT_SPEED_THRESHOLD, System.getProperty(BusinessConstant.ConfigData.CLIENT_UPLOAD_LIMIT_SPEED_THRESHOLD, String.valueOf(StorageFormat.transformSize("100mb", "byte"))));
